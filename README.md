...
This is an function that take two values and return the sum. This is also a lambda expression. The expression doesn’t have a concrete name (like add_two_num), and it specifies that it is adding two values.
